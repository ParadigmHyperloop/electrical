...
ISP_S[0..3]
Text Notes 15350 6550 0    60   ~ 0
I2C Capable Pins:\nSERCOM4: 21+22\nSERCOM3: 25+26\nSERCOM5: 31+32\nSERCOM2: 13+14\n
$Comp
L GND #PWR0215
U 1 1 59E6B342
P 12300 9050
F 0 "#PWR0215" H 12300 8800 50  0001 C CNN
F 1 "GND" H 12300 8900 50  0000 C CNN
F 2 "" H 12300 9050 50  0000 C CNN
F 3 "" H 12300 9050 50  0000 C CNN
	1    12300 9050
	1    0    0    -1  
$EndComp
...
U 1 1 59E72263
P 1250 4350
F 0 "#PWR0216" H 1250 4100 50  0001 C CNN
...
U 1 1 5A09E1DC
P 13150 4800
F 0 "TP2201" H 13150 4900 50  0000 C CNN
F 1 "Conn_01x01" H 13150 4700 50  0001 C CNN
F 2 "hyperCustom:Testpoint_circle_0.5mm" H 13150 4800 50  0001 C CNN
...
U 1 1 5A0AA08F
P 4500 2100
F 0 "#PWR0217" H 4500 1850 50  0001 C CNN
...
U 1 1 5A0AC21B
P 2100 4200
F 0 "#PWR0218" H 2100 3950 50  0001 C CNN
...
Low-pass filter
Text Notes 10500 5000 0    120  ~ 24
Chip Wiring
...
U 1 1 5A13F166
P 2800 2000
F 0 "#PWR0219" H 2800 1750 50  0001 C CNN
...
U 1 1 5A13F196
P 850 1200
F 0 "#PWR0220" H 850 1050 50  0001 C CNN
...
U 1 1 5A1411D0
P 850 2000
F 0 "#PWR0221" H 850 1750 50  0001 C CNN
...
U 1 1 5A1416C8
P 2700 2800
F 0 "#PWR0222" H 2700 2650 50  0001 C CNN
...
U 1 1 5A142050
P 12000 5100
F 0 "#PWR0223" H 12000 4950 50  0001 C CNN
...
U 1 1 5A0D576C
P 7700 4650
F 0 "#PWR0224" H 7700 4500 50  0001 C CNN
...
U 1 1 5A0DF272
P 800 6600
F 0 "#PWR0225" H 800 6350 50  0001 C CNN
...
U 1 1 5A0DF2F9
P 1600 6600
F 0 "#PWR0226" H 1600 6350 50  0001 C CNN
...
U 1 1 5A0E3348
P 850 8900
F 0 "#PWR0227" H 850 8650 50  0001 C CNN
...
U 1 1 5A0E334F
P 1650 8900
F 0 "#PWR0228" H 1650 8650 50  0001 C CNN
...
PA30
Text Label 14500 8550 0    60   ~ 0
PA31
$Comp
L IC_MICROCHIP_SAMD21G18A-A U1701
U 1 1 59E6DC4F
P 12600 7100
F 0 "U1701" H 10950 8750 50  0000 C CNN
F 1 "IC_MICROCHIP_SAMD21G18A-A" H 14050 5450 50  0000 C CNN
F 2 "Housings_QFP:TQFP-48_7x7mm_Pitch0.5mm" H 12600 5950 50  0001 C CIN
...
Wire Wire Line
	12200 5350 12200 4800
Wire Wire Line
	12200 4800 12950 4800
Wire Wire Line
	4500 1450 4500 1150
Wire Wire Line
	4500 1150 5250 1150
...
Wire Wire Line
	14450 5750 15100 5750
Wire Wire Line
	14450 5650 15100 5650
Wire Wire Line
	850  7650 850  8450
Wire Wire Line
	850  8250 1100 8250
...
Wire Wire Line
	14450 6150 14750 6150
Wire Wire Line
	14450 6250 14750 6250
Wire Wire Line
	14450 6350 14750 6350
Wire Wire Line
	14450 6450 14750 6450
Wire Wire Line
...
Wire Wire Line
	10750 6350 10450 6350
Wire Wire Line
	10750 6450 10450 6450
Wire Wire Line
...
U 1 1 5B3AF7DC
P 8550 6350
F 0 "R2210" V 8500 6100 50  0000 C CNN
F 1 "0" V 8500 6550 50  0000 C CNN
...
U 1 1 5B3AFE93
P 8550 6450
F 0 "R2329" V 8500 6200 50  0000 C CNN
F 1 "0" V 8500 6650 50  0000 C CNN
F 2 "Resistors_SMD:R_0805_HandSoldering" V 8480 6450 50  0001 C CNN
...
U 1 1 5B3AFF55
P 8550 6550
F 0 "R2330" V 8500 6300 50  0000 C CNN
F 1 "0" V 8500 6750 50  0000 C CNN
F 2 "Resistors_SMD:R_0805_HandSoldering" V 8480 6550 50  0001 C CNN
...
U 1 1 5B3B000A
P 8550 6650
F 0 "R2331" V 8500 6400 50  0000 C CNN
F 1 "0" V 8500 6850 50  0000 C CNN
F 2 "Resistors_SMD:R_0805_HandSoldering" V 8480 6650 50  0001 C CNN
